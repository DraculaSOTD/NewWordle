    ...
    return (
        <View style={{ width: '100%',alignItems:'center'}}>
            <Animated.Text entering={SlideInLeft.springify().mass(0.5)}style={styles.title}>
                {won ? 'Congratulations' : 'Try Again Tomorrow'}
            </Animated.Text>
            ...
            <View style={{flexDirection:'row', padding:10}}>
                ...
                <Pressable onPress={share}
                    style={{
                        flex: 1, backgroundColor: colors.primary, borderRadius: 25, alignItems: 'center',
                    justifyContent:'center'}}>
                    <Text syle={{color: colors.lightgrey, fontWeight: 'bold'}}>
                        Share</Text>
                </Pressable>
            </View>
        </View>
